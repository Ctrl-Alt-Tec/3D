...
Sidebar.Object = function ( editor ) {
	...
	*/
	...
	var objectPositionX = new UI.Number().setPrecision( 3 ).setWidth( '33%' ).onChange( update );
	...
	var objectRotationX = new UI.Number().setStep( 10 ).setUnit( '°' ).setWidth( '33%' ).onChange( update );
